...
func (this *UserLoginController) Post() {
	...
	if phone == "" {
		this.Data["json"] = map[string]interface{}{"code": 0, "message": "请填写手机号码"}
	}
	if password == "" {
		this.Data["json"] = map[string]interface{}{"code": 0, "message": "请输入密码"}
	}
	err, user := models.UserLogin(phone, password)
	if err == nil {
		this.SetSession("userLogin", "1")
		this.Data["json"] = map[string]interface{}{"code": 1, "message": "恭喜你，登录成功", "user": user}
	} else {
