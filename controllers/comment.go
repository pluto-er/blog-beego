...
func (this *AddCommentController) Post() {
	...
	id, err1 := models.AddComment(data)
	if err1 == nil {
		this.Data["json"] = map[string]interface{}{"code": 1, "message": "评论成功", "id": id}
	} else {
		this.Data["json"] = map[string]interface{}{"code": 0, "message": "评论失败", "id": id}
	}
	this.ServeJSON()
